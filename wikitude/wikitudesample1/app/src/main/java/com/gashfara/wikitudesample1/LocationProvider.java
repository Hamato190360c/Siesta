//位置情報の位置情報プロバイダー。そのまま使う。どのアプリでも同じ。
...
public class LocationProvider implements ArchitectViewHolderInterface.ILocationProvider {
    ...
    public void onResume() {
        if ( this.locationManager != null && this.locationListener != null ) {
            ...
            /** 0, recommended: handle this event properly in your app, e.g. forward user directly to location-settings, new Intent( Settings.ACTION_LOCATION_SOURCE_SETTINGS ) */
