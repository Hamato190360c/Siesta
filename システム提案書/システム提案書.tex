...
\begin{table}[H]
  ...
  \begin{center}
    \begin{tabular}{|c|c|c|c|c|} \hline
      ...
      システム開発人件費&10,000&560日&5,600,000&工数内訳 8人×70日 \\ \hline
      \multicolumn{3}{|c|}{開発費}&5,780,000&上記4つの合計 \\ \hline
      \multicolumn{3}{|c|}{維持費}&4,335,000&減価償却期間×開発費×0.15 \\ \hline %減価償却期間×開発費×0.15
      \multicolumn{3}{|c|}{総コスト}&10,115,000&開発費+維持費 \\ \hline
    \end{tabular}
  \end{center}
\end{table}
本システムを実現させ、動物園入園者が増加した場合の利益を考慮すると、5年間で20％程度の来園者の増加が見込まれると想定します。この場合、2015年度の時点では来園者は約17万人であり、2017年から2022年の間に来園者が年間20.4万人にまで到達することが見込めます。
システム化による効果の資産を以下に示します．
